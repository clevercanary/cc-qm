 ...
 */
QueryModel.prototype.addRegexpQueryFilter = function(fieldName, regexpString, options) {

    var filter = this.buildRegexpQueryFilter(fieldName, regexpString, options);
    this.getFilters().push(filter);
};
...
QueryModel.prototype.buildRegexpQueryFilter = function(fieldName, value, options) {
    ...
    return buildQueryFilter.call(this, FILTER_TYPES.REGEXP, fieldName, value, options);
};
 ...
 * @returns {{filterType: string, fieldName: string, value: *}}
 */
function buildQueryFilter(filterType, fieldName, value, options) {
...
function init(obj) {
    ...
    this.listFilters = obj.listFilters || [];
